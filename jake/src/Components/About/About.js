	...
	<div className="athelas">
	  <div className="vh-100 dt w-100 tc bg-dark-gray white cover about2" >
	    <div className="dtc v-mid">
	      ...
	      <div className="ph0 mh0 measure f4 lh-copy center">
	        ...
	        <div className="f6 ttu tracked fs-normal">Jake Duff</div>
	      </div>
	    </div>
	  </div>
	  <div className="center measure-wide f5 pv5 lh-copy ph2">
	    ...
	    <p>
		 ...
		 I am fascinated in Web Application Design and Mobile Application Design. In my free time I
		 ...
		 <p>
			...
			If you would like to find out more about my work please refer to the "Projects" section of this site to see some of my
