...
<div className='bg'>
  ...
  <article className="bt ">
    <a className="db pv4 ph3 ph0-l no-underline  dim" 
    href="https://www.collinsdictionary.com/dictionary/english/achiever" 
    target="_blank"
...
<footer className="pv4 ph3 tc">
  ...
  <a className="link near-black hover-silver dib mh3 tc" href="https://github.com/jaked3" 
   target="_blank"
     rel="noopener noreferrer" 
     title="GitHub">
  ...
  <a className="link hover-silver near-black dib mh3 tc" href="https://www.instagram.com/jakeduff3/?hl=en" 
   target="_blank"
     rel="noopener noreferrer"
     title="Instagram">
  ...
  <a className="link hover-silver near-black dib mh3 tc" href="https://ca.linkedin.com/in/jakeduff3"
   target="_blank"
     rel="noopener noreferrer"
      title="LinkedIn">
